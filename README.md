# EV Solar Charger
Home Assistant Blueprint using Tesla API or OCPP to charge EV using surplus solar electricity and weather forecast.
...
- If using OCPP charger, configure you charger to point the HA OCPP central server, eg. ws://homeassistant.local:9000
...
-------------------------------------------------------------------------------------------
Note: This is theoretical only since I don't have 2 Tesla cars to test this, but happy for any feedback.  To ensure power is allocated according to weighting, the "Main power net" update cycle should be the same as the script looping cycle, ie. 1 minute.
